        ...
        <div class='w-1/4'>
          ...
          <div className='aisle-footer-right'>
            ...
            <div>
              ...
              <Link to='../snack'><img src='/media/images/forward.svg' class='icon-button align-right' alt='forward' onClick={() => {localStorage.setItem('my_cart', JSON.stringify(my_cart))}}/></Link>
            </div>
          </div>
        </div>
      </div>
