      ...
      <div class='flex flex-row'>
        <div class='w-3/4'>
          ...
          <div className='aisle-footer-left'>
            <div />
            {/* <img src='/media/images/back.svg' class='icon-button' /> */}
            <div />
          </div>
        </div>
        ...
        <div class='w-1/4'>
          ...
          <div className='aisle-footer-right'>
            ...
            <div>
              ...
              <Link to='../vegetable'><img src='/media/images/forward.svg' class='icon-button align-right' alt='forward' onClick={() => {localStorage.setItem('my_cart', JSON.stringify(my_cart))}}/></Link>
            </div>
          </div>
        </div>
      </div>
