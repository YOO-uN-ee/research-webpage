...
const Final= () => {
  ...
  const storeData = async() => {
    const res = await axios.post("https://research-backend-3mwd.onrender.com/api/auth/add", {
      ...
      "treatment_visited":localStorage.getItem('treatment_visited'), "treatment_aisle":localStorage.getItem('treatment_aisle'), "treatment_option":localStorage.getItem('treatment_option'), "treatment_time":localStorage.getItem('treatment_time'),"sub_action":localStorage.getItem('sub_action')
    });
  };
